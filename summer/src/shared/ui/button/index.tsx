...
export const ButtonSmall = memo((props: ButtonProps) => {
  return Button({
    ...props,
    className: `button--small ${props.className}`,
  })
})
...
export const ResetFilterButton = memo((props: ButtonProps) => {
  return (
    <TextButton {...props}>
      Сбросить всё
